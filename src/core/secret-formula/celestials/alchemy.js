...
export const alchemyResources = {
  ...
  "replication": {
    ...
    symbol: "Ξ",
    isBaseResource: true,
    effect: amount => Decimal.pow10(amount / 65),
    tier: 1,
    uiOrder: 4,
    unlockedAt: 5,
  ...
  "dilation": {
    ...
    symbol: "Ψ",
    isBaseResource: true,
    effect: amount => Decimal.pow10(amount / 20),
    tier: 1,
    uiOrder: 5,
    unlockedAt: 6,
  ...
  "cardinality": {
    ...
    effect: amount => 1 + 0.2 / (1 + amount / 1200),
    tier: 2,
    uiOrder: 3,
    unlockedAt: 8,
  ...
  "dimensionality": {
    ...
    symbol: "ρ",
    isBaseResource: false,
    effect: amount => Decimal.pow10(amount ** 2.22),
    tier: 2,
    uiOrder: 1,
    unlockedAt: 10,
  ...
  "synergism": {
    ...
    isBaseResource: false,
    effect: amount => {
      const rawValue = 0.3 + 1.3 * Math.sqrt(amount / 2500);
  ...
  "uncountability": {
    ...
    symbol: "Θ",
    isBaseResource: false,
    effect: amount => 6500 * Math.sqrt(amount / 25000),
    tier: 4,
    uiOrder: 3,
    unlockedAt: 19,
  ...
  "multiversal": {
    ...
    symbol: "Σ",
    isBaseResource: false,
    effect: amount => 128 * Math.pow(amount / 25000, 2),
    tier: 4,
    uiOrder: 5,
    unlockedAt: 16,
