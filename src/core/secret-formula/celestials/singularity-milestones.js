...
export const singularityMilestones = {
  ...
  continuumMult: {
    ...
    effect: completions => completions * 0.055,
  ...
  darkMatterMult: {
    ...
    effect: completions => Math.pow(1.75, completions),
  ...
  darkDimensionCostReduction: {
    ...
    effect: completions => Math.pow(0.3, completions),
  ...
  singularityMult: {
    ...
    effect: completions => Math.pow(2.5, completions),
  ...
  darkDimensionIntervalReduction: {
    ...
    effect: completions => Math.pow(0.5, completions),
    effectFormat: x => `/ ${format(1 / x, 2, 2)}`,
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  improvedAscensionDM: {
    ...
    effect: completions => 5000 * (completions ** 2),
  ...
  ascensionIntervalScaling: {
    ...
    effect: completions => 1200 - 120 * completions,
  ...
  intervalCostScalingReduction: {
    ...
    effect: completions => 1 - 0.085 * completions,
  ...
  darkFromTesseracts: {
    ...
    effect: () => Math.pow(1.35, Tesseracts.effectiveCount),
    effectFormat: x => formatX(x, 2, 2),
  ...
  multFromInfinitied: {
    ...
    effect: () => Math.clampMin(Currency.infinitiesTotal.value.pLog10() / 800, 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  dilatedTimeFromSingularities: {
    ...
    effect: () => 1 + Math.clampMax(Math.log10(Currency.singularities.value) / 100, 0.5),
  ...
  darkFromTheorems: {
    ...
    effect: () => Math.sqrt(Math.clampMin((Currency.timeTheorems.value.log10()) / 37, 1)),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  dim4Generation: {
  ...
  darkFromDM4: {
    ...
    effect: () => Math.clampMin(DarkMatterDimension(4).amount.pow(0.12).toNumber(), 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.SELF_BOOST,
  },
  ...
  theoremPowerFromSingularities: {
    ...
    effect: () => 1 + Math.log10(Currency.singularities.value + 1) / 60,
  ...
  darkFromGamespeed: {
    ...
    effect: () => Math.clampMin(Math.log10(getGameSpeedupFactor()) ** 1.25, 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
  ...
  infinitiedPow: {
    ...
    repeat: 0,
    limit: 1,
    description: "Infinities and Dark Matter Annihilation multiplier gain a power effect based on Singularities",
