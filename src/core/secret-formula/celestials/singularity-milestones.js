...
export const singularityMilestones = {
  ...
  ascensionIntervalScaling: {
    ...
    effect: completions => 1200 - 100 * completions,
  ...
  darkFromTesseracts: {
    ...
    effect: () => Math.pow(1.2, Tesseracts.effectiveCount),
    effectFormat: x => formatX(x, 2, 2),
  ...
  dilatedTimeFromSingularities: {
    ...
    effect: () => 1 + Math.clampMax(Math.log10(Currency.singularities.value) / 100, 0.36),
  ...
  darkFromGamespeed: {
    ...
    effect: () => Math.clampMin(Math.log10(getGameSpeedupFactor() / 1e120), 1),
    effectFormat: x => formatX(x, 2, 2),
    upgradeDirection: LAITELA_UPGRADE_DIRECTION.BOOSTS_LAITELA,
  },
